                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="col-md-6 float-end">
                                <a href="{{ route('all-order') }}" class="btn btn-success float-end mx-1" style="transform: translateY(-40px);">Back</a>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6 float-end">
                                    <a href="{{ route('all-order') }}" class="btn btn-success float-end mx-1">Back</a>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
