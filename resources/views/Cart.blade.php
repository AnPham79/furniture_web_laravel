                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="mb-4 mx-lg-5">
                            ...
                            <form action="{{ route('add-coupon') }}" class="mt-2">
                                <div class="form-group">
                                    <input type="text" class="form-control mr-2" name="code" value="{{ session()->has('code') ? session('code') : '' }}">
                                    <button class="btn btn-warning rounded-0 text-white mt-2 float-end">Use</button>
                                </div>
                            </form>
                            <form action="{{ route('delete-coupon') }}" method="POST">
                                @csrf
                                <button class="btn btn-warning rounded-0 text-white mt-2 float-end mx-1">Un Use</button>
                            </form>
                        </div>
                    </div>
